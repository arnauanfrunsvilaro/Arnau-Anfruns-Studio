...
const HeroGraphic = () => (
  <svg viewBox="0 0 900 1600" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full grayscale transition-all duration-1000">
    <image 
      ...
      className="contrast-125 brightness-90"
    />
    ...
    {/* Elementos técnicos minimalistas en B&N */}
    <rect x="40" y="40" width="820" height="1520" stroke="white" strokeWidth="0.5" strokeOpacity="0.1" fill="none" />
    <path d="M40 100 L60 100" stroke="white" strokeWidth="1" strokeOpacity="0.3" />
    <path d="M840 100 L860 100" stroke="white" strokeWidth="1" strokeOpacity="0.3" />
  </svg>
);
